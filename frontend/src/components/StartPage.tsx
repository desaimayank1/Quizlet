...
export const StartPage: React.FC = () => {
    ...
    const { resetAnswers, setCurrentQuestion } = useTestStore()
                    ...
                    <div className="flex-1 flex flex-col justify-center space-y-8">
                        <div className="grid gap-3">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-0  text-base shadow-sm"
                        ...
                        <div className=" p-4 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl border border-indigo-100 shadow-inner">
                            ...
                            <ul className="text-base text-gray-700 space-y-2">
                                <li>✅ Total Questions: <span className="font-semibold">8</span></li>
                        ...
                        <div className="px-8 py-8 bg-gradient-to-br from-emerald-50 to-green-100 rounded-2xl text-center border border-green-200 shadow-xl">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 justify-center">
                                <button
                                    ...
                                    className="flex-1 flex items-center justify-center gap-2 bg-gray-300 text-gray-700 px-1 py-3 rounded-xl font-medium hover:bg-gray-400 transition-all shadow-md text-lg"
                                >
                                    Back
                                </button>
                                <button
                                    onClick={onRetake}
                                    className="flex-1 flex items-center justify-center gap-2 bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-1 py-3 rounded-xl font-medium hover:from-indigo-700 hover:to-purple-700 transition-all shadow-md text-lg"
                                >
                                    <RotateCcw size={20} />
                                    Retake Test
                                </button>
